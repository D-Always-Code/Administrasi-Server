...
2. Patching OS
3. Uninstall semua Services manual 
...
9. Lakukan Testing di Local Project Next.JS
    ...
    - Create user di DBMS : sudo mysql -u root -p
        - CREATE USER 'userwebdinamis_2388010045'@'localhost' IDENTIFIED BY 'Setiawan5525!';
        - GRANT ALL PRIVILEGES ON *.* TO 'userwebdinamis_2388010045'@'localhost';
        - FLUSH PRIVILEGES;
        - exit;
